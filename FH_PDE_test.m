...
%nowe
FH_data.k_1=0.000033192813737;
FH_data.k_2=0.008788730063744;
...
FH_data.section_name='Z4';

FH_data.Z4_input_signal_function_name='FH_Z4_ctrl_fnc_input(u,t)';
...
FH_data.inputs_nr=2;
FH_data.signals_names={'FH11_Z3_TEMP_PV','FH11_Z4_MIX_PRES_PV','FH11_Z4_TEMP_PV','FH11_Z4_TEMP_SP','FH11_PULL'};
...
sections_len=[-6.5412 -4.2190 -2.1536 0 1];
...
ident_section=MD_ident_section(2,{'FH11_Z3_TEMP_PV','FH11_Z4_MIX_PRES_PV',...
    'FH11_Z4_TEMP_PV','FH11_Z4_TEMP_SP','FH11_PULL'},[0.0344 1.236],1055,FH_data.file_path,MD_constant_values_Z4_short);
