classdef MD_constant_values_Z3
    properties (Constant)
        ...
        new_model_intervals=8;           % by³o 4
        new_model_min_inputs=6;          % minimalna liczba wejsc z duzymi zmianami dla identyfikacji
        ...
        model_change_threshold=MD_constant_values.T_sim;     % próg od którego re-identyfikacja - bylo MD_constant_values.T_sim*0.2
        ...
        ident_models1_N=5;
        ident_models1_M=6;
        ident_models1_h=440;            %!!!!!!!!!!!!!!!!!! 500 dla rzeczywistych
        ident_models1_n=1;
        ident_models1_m=4;
        ...
        ident_models2_N=3;
        ident_models2_M=4;
        ident_models2_h=850;         %25
        ident_models2_n=1;
        ident_models2_m=3;
        ident_models2_eta=[1 1 1 1 1];
        
        ident_models3_N=3;
        ident_models3_M=4;
        ident_models3_h=500;         %25
        ident_models3_n=1;
        ident_models3_m=3;
        ...
        ident_models4_N=5;
        ident_models4_M=6;
        ident_models4_h=440;         %25
        ident_models4_n=1;
        ident_models4_m=3;
        ident_models4_eta=[1 1 1 1];
        %{
        ident_models3_N=6;
        ident_models3_M=7;
        ident_models3_h=35;
