classdef MD_constant_values_Z4_multi_sim
    properties (Constant)
        ...
        N_lin=4;
        M_lin=5;
        min_op_diff=6;                   % minimalny przedzia³ pomiêdzy dwoma linearyzacjami - chyba niepotrzebny
        ...
        T_ob=MD_constant_values_Z4_PDE_sim.T_sim*2; % szerokœæ interwa³u obserwacji  %%!!!!!!!!!!!!!!!!!! 500 dla rzeczywistych (2*250)
