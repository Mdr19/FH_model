classdef MD_constant_values_Z4_short
    properties (Constant)
        ...
        N_lin=4;
        M_lin=5;
        min_op_diff=1;                   % minimalny przedzia³ pomiêdzy dwoma linearyzacjami
        ...
        new_model_min_inputs=2;          % minimalna liczba wejsc z duzymi zmianami dla identyfikacji
        ident_intervals=4*2*2;           % by³o 16
        min_inputs_ident=2;              % minimalna liczba wejsæ dla modelu
        T_ob=MD_constant_values_Z4.T_sim*2; % szerokœæ interwa³u obserwacji  %%!!!!!!!!!!!!!!!!!! 500 dla rzeczywistych (2*250)
        T_sim=250;                                               % szerokoœæ interwa³u syulacji
        model_change_threshold=MD_constant_values_Z4.T_sim;     % próg od którego re-identyfikacja - bylo MD_constant_values.T_sim*0.2
