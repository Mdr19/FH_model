function [ best_model, model_params, model_initial_state] = MD_model_ident_LSM_nonzero(sys_input,sys_output,method_params,plot_nr)
...
for i=1:method_params.ident_models_nr
    ...
    switch method_params.initial_model_method
        case 1
            ni_min=MD_MFM_MISO_ident(ident_inputs_nr,sys_ident_input,sys_output,method,params(i).eta',method_params,params(i));
            for k=1:params(i).m
                ni_min(k)=-ni_min(k);
            end
        ...
        case 3
            [ni_min, ~]=MD_MFM_model_ident_out_LSM(ident_inputs_nr,sys_ident_input,sys_output,method_params,params(i));
