classdef MD_constant_values_Z4_PDE_sim
    properties (Constant)
        ...
        model_change_threshold=MD_constant_values_Z4_PDE_sim.T_sim;     % próg od którego re-identyfikacja - bylo MD_constant_values.T_sim*0.2
